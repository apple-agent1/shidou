...
const VOICES = {
  ...
  gentle: {
    name: "温柔风格",
    motifs: [
      ["清晨醒来", "你", "在微雨里", "捧起", "一小束白花", "于是", "沉默", "轻轻靠近", "掌心的温度"],
      ["黄昏将至", "我们", "沿着旧街", "听见", "屋檐下的风铃", "而", "思念", "慢慢变得", "柔软的灯火"],
      ["春日午后", "孩子", "在窗边", "抚摸", "熟睡的云朵", "仿佛", "安心", "带着微光", "落进怀里"],
      ["月色升起", "归人", "穿过花园", "留住", "一片迟来的香气", "直到", "等待", "悄悄长成", "温暖的回音"],
      ["雨停之后", "我", "靠近你的影子", "拾起", "潮湿的花瓣", "也许", "温柔", "仍旧愿意", "替夜晚守灯"],
      ["多年以后", "故人", "在信纸之间", "认出", "褪色的春天", "所以", "记忆", "依然轻柔", "回到我们身边"],
    ],
  },
  hope: {
    name: "希望风格",
    motifs: [
      ["天亮以前", "我们", "越过长坡", "守住", "第一线晨光", "即使", "风雨", "仍在远处", "打开一扇门"],
      ["新的一天", "少年", "站在原野", "播下", "一粒发光的种子", "于是", "勇气", "迎着太阳", "长成绿色道路"],
      ["冬天尽头", "旅人", "穿过薄雾", "看见", "尚未融化的星", "而", "愿望", "安静等待", "春天再次抵达"],
      ["黎明到来", "孩子们", "沿着河流", "追逐", "刚刚醒来的鸟群", "直到", "天空", "渐渐明亮", "把远方交还"],
      ["此刻之后", "你", "在废墟旁", "点燃", "一盏不灭的灯", "哪怕", "孤单", "仍然相信", "明日会有回声"],
      ["雨季过去", "我", "向着山顶", "举起", "被风洗净的手", "所以", "希望", "重新学习", "如何成为翅膀"],
    ],
  },
  sorrow: {
    name: "悲哀风格",
    motifs: [
      ["雨落以后", "我", "在空房间", "收起", "未寄出的信", "然而", "回声", "反复触碰", "离去的名字"],
      ["最后一夜", "故人", "站在旧站台", "望着", "熄灭的远灯", "直到", "沉默", "缓缓覆盖", "来不及的告别"],
      ["秋天深处", "旅人", "穿过荒园", "拾起", "一片枯萎的叶", "而", "孤独", "沿着掌纹", "回到无人之地"],
      ["钟声停下", "你", "隔着多年", "忘记", "那扇半开的窗", "仿佛", "眼泪", "悄无声息", "替时间落幕"],
      ["黄昏之后", "无人", "守着海岸", "听见", "退潮留下的空白", "可是", "思念", "依旧漫长", "没有归来的方向"],
      ["梦醒以前", "影子", "在旧照片里", "寻找", "曾经明亮的笑", "也许", "遗憾", "慢慢变冷", "成为夜的余音"],
    ],
  },
  striver: {
    name: "奋斗者风格",
    motifs: [
      ["天色未明", "赶路的人", "沿着陡坡", "迈出", "沉重的第一步", "即使", "疲惫", "仍然向前", "把黑夜走亮"],
      ["风暴来临", "我们", "站在旷野", "握紧", "尚未熄灭的火", "然而", "信念", "迎着逆风", "撑起新的天空"],
      ["漫长冬日", "建设者", "穿过泥泞", "托起", "清晨的脚手架", "直到", "汗水", "一寸一寸", "筑成明日轮廓"],
      ["失败之后", "少年", "面对高墙", "重新", "校准自己的方向", "哪怕", "伤痕", "仍在提醒", "道路从未终止"],
      ["群山之间", "攀登者", "踏过碎石", "寻找", "云层之外的光", "因为", "坚持", "比风更久", "抵达更高之处"],
      ["明日之前", "我", "向着远方", "举起", "被磨亮的理想", "所以", "勇敢", "继续生长", "让脚步成为答案"],
    ],
  },
};
